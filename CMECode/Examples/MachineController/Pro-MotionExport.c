...
PMDAxisHandle hAtlasAxis;
  ...
  PMD_RESULT(PMDWriteIO (phAxis, 0, 0x0000))
  PMD_RESULT(PMDSetSerialPortMode (phAxis, 4, 0, 1, 0, 0))
  PMD_RESULT(PMDSetCANMode (phAxis, 0, 0))
  ...
  PMD_RESULT(PMDSetEncoderToStepRatio (phAxis, 1, 1))
  ...
  PMD_RESULT(PMDSetCurrent (phAxis, 0, 32767))
  PMD_RESULT(PMDSetCurrent (phAxis, 1, 20))
  PMD_RESULT(PMDSetCurrent (phAxis, 2, 0))
  ...
  PMD_RESULT(PMDSetCurrentFoldback (phAxis, 0, 5242))
  ...
  PMD_RESULT(PMDSetOperatingMode (phAxis, 0x0031))
}

void SetupAxis2(PMDAxisHandle* phAxis)
{
PMDresult result;
  ...
  PMD_RESULT(PMDSetEventAction (phAxis, 0, 0x0007))
  PMD_RESULT(PMDSetMotorType (phAxis, 4))
  PMD_RESULT(PMDSetOutputMode (phAxis, 8))
  PMD_RESULT(PMDSetPositionErrorLimit (phAxis, 65535))
  PMD_RESULT(PMDSetSettleTime (phAxis, 0))
  PMD_RESULT(PMDSetSettleWindow (phAxis, 0))
  PMD_RESULT(PMDSetTrackingWindow (phAxis, 0))
  PMD_RESULT(PMDSetActualPositionUnits (phAxis, 1))
  PMD_RESULT(PMDSetStepRange (phAxis, 1))
  PMD_RESULT(PMDSetEncoderModulus (phAxis, 0))
  PMD_RESULT(PMDSetEncoderSource (phAxis, 2))
  PMD_RESULT(PMDSetEncoderToStepRatio (phAxis, 1, 1))
  PMD_RESULT(PMDSetGearMaster (phAxis, 0, 0))
...
void SetupAxis3(PMDAxisHandle* phAxis)
{
PMDresult result;
...
void SetupAxis4(PMDAxisHandle* phAxis)
{
PMDresult result;
