...
#define CMOTION_MINOR_VERSION	2
...
PMDCFunc PMDGetVersion                (PMDAxisInterface axis_intf, PMDuint16 *family, PMDuint16 *motorType, PMDuint16 *numberAxes, PMDuint16 *special_and_chip_count, PMDuint16 *custom, PMDuint16 *major, PMDuint16 *minor);
